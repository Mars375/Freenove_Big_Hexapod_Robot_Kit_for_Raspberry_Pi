...
from tachikoma.features.autonomous.obstacle_avoidance import get_obstacle_avoidance
from tachikoma.features.vision.object_detection import get_object_detector
from tachikoma.features.vision.qr_scanner import get_qr_scanner
